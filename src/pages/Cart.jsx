...
const Cart = () => {
    ...
    const cart = [
      {
        ...
        price: 100,
        quantity: 2,
        image: "src/assets/image/organic-honey-bottles-product-photography.jpg",
      },
      {
        id: 2,
        name: "Product 2",
     ...
     if (cart.length === 0) {
       return (
         <>
           <div className='absolute fixed top-0 right-0 z-50 flex flex-col h-auto w-8/12 ml-auto bg-gray-200 rounded-lg shadow-md p-4 gap-6 '>
  ...
  return (
    <>
      <div className="absolute fixed top-0 right-0 z-50  w-8/12 ml-auto bg-gray-200 rounded-lg shadow-md p-4 h-screen ">
        <div className="  flex flex-col  gap-6 scrollbar-thin h-100vh  ">
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:w-8/12 sm:mx-right-auto sm:ml-auto">
            <div className="space-y-4 scrollbar-thin h-80vh">
              {cart.map((item) => (
                <div
                  key={item.id}
